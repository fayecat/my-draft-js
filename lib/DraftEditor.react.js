...
var DraftEditor = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2._buildHandler = function _buildHandler(eventName) {
    ...
    return function (e) {
      ...
      var textTypes = ['unstyled', 'paragraph'];
      var events = ['onSelect', 'onFocus'];

      if (!_this2.props.readOnly && (events.indexOf(eventName) !== -1 || textTypes.indexOf(type) !== -1)) {
  ...
  _proto2.render = function render() {
    ...
    var _this$props2 = this.props,
        ...
        sortableWrapper = _this$props2.sortableWrapper,
        sortableConfigs = _this$props2.sortableConfigs;
    var rootClass = cx({
