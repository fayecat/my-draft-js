...
var DraftEditor = /*#__PURE__*/function (_React$Component2) {
  ...
  _proto2._buildHandler = function _buildHandler(eventName) {
    ...
    return function (e) {
      ...
      var textTypes = ['unstyled', 'paragraph', 'ordered-list-item', 'unordered-list-item', 'quote'];
      var events = ['onSelect', 'onFocus'];

      if (!_this2.props.readOnly && (events.indexOf(eventName) !== -1 || textTypes.indexOf(type) !== -1) && eventName !== 'onBlur') {
