...
var DraftEditorContents = /*#__PURE__*/function (_React$Component) {
  ...
  _proto.shouldComponentUpdate = function shouldComponentUpdate(nextProps) {
    ...
    console.log(nextEditorState, 'nextEditorStatenextEditorStatenextEditorStatenextEditorState'); // Text direction has changed for one or more blocks. We must re-render.
